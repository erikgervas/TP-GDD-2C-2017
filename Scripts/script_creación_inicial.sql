...
DROP function SQL_BOYS.obtenerFecha GO
...
DROP FUNCTION SQL_BOYS.obtenerUsuario GO
...
/* Selección de sucursal y rol */

DROP FUNCTION SQL_BOYS.obtenerSucursales GO
...
DROP FUNCTION SQL_BOYS.obtenerRol;
...
DROP FUNCTION SQL_BOYS.obtenerRoles;
...
DROP FUNCTION SQL_BOYS.obtenerSucursalPorNombre GO
...
DROP FUNCTION SQL_BOYS.obtenerSucursalPorDireccion GO
...
DROP FUNCTION SQL_BOYS.obtenerSucursalPorCodigoPostal GO
...
DROP FUNCTION SQL_BOYS.obtenerSucursalPorFiltrado GO
...
DROP PROCEDURE SQL_BOYS.actualizarSucursal GO
...
DROP PROCEDURE SQL_BOYS.darDeBajaSucursal GO
...
DROP FUNCTION SQL_BOYS.obtenerProximoNroPago GO
...
DROP FUNCTION SQL_BOYS.obtenerFactura GO
...
DROP FUNCTION SQL_BOYS.existeCliente GO
...
DROP PROCEDURE SQL_BOYS.insertarItemPagoDeFactura GO
...
drop function SQL_BOYS.obtenerFacturasARendir go
...
drop function SQL_BOYS.empresasARendir go
...
drop procedure SQL_BOYS.rendirFacturas go
...
drop function SQL_BOYS.facturasDevolvibles go
...
drop procedure SQL_BOYS.devolverFacturaPaga go
