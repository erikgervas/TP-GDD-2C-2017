...
CREATE TABLE Rol_De_Usuario_Por_Sucursal (
	...
	cp_sucursal NUMERIC(18, 0) FOREIGN KEY REFERENCES Sucursal(cp_sucursal) NOT NULL,
...
CREATE TABLE Factura (
	...
	dni_cliente NUMERIC(18, 0) FOREIGN KEY REFERENCES Cliente(dni_cliente) NOT NULL,
	id_empresa INT FOREIGN KEY REFERENCES Empresa(id_empresa) NOT NULL,
	numero_rendicion NUMERIC(18, 0) FOREIGN KEY REFERENCES Rendicion(numero_rendicion)
)
...
CREATE TABLE Devolucion (
	...
	numero_factura NUMERIC(18, 0) FOREIGN KEY REFERENCES Factura(numero_factura)
)
...
CREATE TABLE Item (
	...
	numero_factura NUMERIC(18, 0) FOREIGN KEY REFERENCES Factura(numero_factura) NOT NULL
)

CREATE TABLE Item_Pago (
	id_item INT FOREIGN KEY REFERENCES Item(id_item) NOT NULL,
	numero_factura NUMERIC(18, 0) FOREIGN KEY REFERENCES Factura(numero_factura) NOT NULL,
	numero_pago NUMERIC(18, 0) FOREIGN KEY REFERENCES Pago(numero_pago) NOT NULL,
	CONSTRAINT id_item_pago PRIMARY KEY(id_item, numero_factura, numero_pago)
)

CREATE TABLE Item_Rendicion (
	id_item INT FOREIGN KEY REFERENCES Item(id_item) NOT NULL,
	numero_rendicion NUMERIC(18, 0) FOREIGN KEY REFERENCES Rendicion(numero_rendicion) NOT NULL,
